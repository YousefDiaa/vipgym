...
const servicesList: ServiceItem[] = [
  ...
  },
  {
    ...
    detailedDesc: "ابقَ على اتصال دائم بالعالم أو تابع برامجك المفضلة وأعمالك الهامة أثناء التمرين. نوفر شبكة واي فاي عالية السرعة ومفتوحة تغطي جميع أرجاء الصالتين الداخلية والخارجية لضمان تجربة ترفيهية وإنتاجية متكاملة لجميع رواد النادي.",
    isFree: true,
    tag: "متاح مجاناً",
    image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&w=600&q=80",
    benefits: [
      "سرعة فائقة تتيح بث الموسيقى والفيديوهات الرياضية بجودة عالية (FHD).",
      "اتصال مستقر وسلس وبدون انقطاع في القاعتين الداخلية والخارجية والساونا.",
      "توفير كامل لاستهلاك باقة الإنترنت الشخصية المحدودة الخاصة بك أثناء التمرين.",
      "سهولة الاتصال المباشر لجميع الأعضاء بدون خطوات أو اشتراكات معقدة."
    ]
  }
];
